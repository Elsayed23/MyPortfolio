...
export { projectsData, projectCategories, projectCategoryLabels } from './projects';
...
export const skillSections = [
    ...
    },
    {
        ...
        description: 'Designing robust APIs and server-side application logic.',
        skills: [
            'Node.js', 'Express.js',
            'REST APIs',
            'JWT Authentication',
    ...
    {
        title: 'Database & ORM',
        description: 'Modeling data and keeping persistence layers reliable.',
        skills: [
    ...
    },
    {
        ...
        description: 'Maintaining quality, consistency, and team velocity.',
        skills: [
            'Git', 'GitHub',
            'Postman',
            'Swagger UI',
    ...
    },
    {
        ...
        description: 'Deploying, securing, and optimizing production systems.',
        skills: [
            'Linux',
            'Nginx', 'Apache',
            'Caching Strategies',
    ...
    },
    {
        ...
        description: 'Automating repetitive workflows and extracting web data.',
        skills: [
            'Puppeteer',
            'Browser Automation',
            'Web Scraping',
    ...
    },
    {
        ...
        description: 'Shipping cross-platform desktop experiences.',
        skills: [
            'Electron.js'
        ]
    }
